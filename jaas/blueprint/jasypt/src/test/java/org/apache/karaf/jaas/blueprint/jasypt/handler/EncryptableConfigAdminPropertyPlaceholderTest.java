...
public class EncryptableConfigAdminPropertyPlaceholderTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        bundles.add(getBundleDescriptor(
                "target/jasypt2.jar",
                TinyBundles.newBundle().add("OSGI-INF/blueprint/karaf-jaas-jasypt.xml", getClass().getResource("/OSGI-INF/blueprint/karaf-jaas-jasypt.xml"))
        ...
        bundles.add(getBundleDescriptor(
                "target/test2.jar",
                TinyBundles.newBundle().add("OSGI-INF/blueprint/config-adminTest.xml", getClass().getResource("config-adminTest.xml"))
                        .set("Manifest-Version", "2")
                        .set("Bundle-ManifestVersion", "2")
